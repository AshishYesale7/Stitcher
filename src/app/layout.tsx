...
export const metadata: Metadata = {
  title: 'Stitcher',
  description: 'Connecting you with the perfect tailor.',
  icons: {
    icon: '/favicon.svg',
  }
};
